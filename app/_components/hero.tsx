...
export function Hero() {
  return (
    <section className="bg-black text-white relative overflow-hidden" aria-label="Hero section">
      <div>
        <Image
          src={poliana}
      ...
      <div className="container mx-auto pt-16 pb-16 md:pb-0 px-4 relative">
        <article className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="space-y-6">
            <h1
              className={`${playfair.className} text-3xl md:text-4xl lg:text-5xl font-bold leading-10 text-yellow-500`}
              data-aos="fade-down"
            >
            ...
            <h2
              className={`${roboto.className} text-2xl md:text-3xl lg:text-4xl font-semibold leading-10`}
              data-aos="fade-down"
            >
            ...
            <p
              className={`${roboto.className} lg:text-lg text-zinc-300`}
              data-aos="fade-right"
            >
            ...
            <a
              ...
              className="bg-yellow-400 text-black px-5 py-2 rounded-md font-semibold flex items-center justify-center w-fit gap-2 hover:bg-yellow-300 transition"
            >
            ...
            <div className="mt-8">
              <p className="text-sm mb-4 font-bold text-yellow-600">
